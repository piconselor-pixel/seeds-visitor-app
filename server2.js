    ...
    `IF NOT EXISTS (SELECT 1 FROM vs_users WHERE username = 'admin')
     BEGIN
       ...
       VALUES (
         ...
         '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', -- bcrypt("password") demo; REPLACE with your hash for "admin123"
         'admin'
       )
     END`
  ];
...
app.post('/api/visitors', async (req, res) => {
  try {
    ...
    // Email to host (ignore failures in response)
    const mailOptions = {
...
// PROTECTED – List visitors (for admin/reception)
