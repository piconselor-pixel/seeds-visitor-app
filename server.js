...
// Email Config (UPDATE WITH YOUR SMTP)
const EMAIL_CONFIG = {
    service: 'gmail',
    auth: {
        user: 'your-email@gmail.com', // UPDATE THIS
        pass: 'your-app-password'     // UPDATE THIS (App Password for Gmail)
    }
};
...
async function createTables() {
    const queries = [
        ...
        BEGIN
            ...
            VALUES ('admin', 'admin@seedsfincap.com', '$2b$10$W1z7z8z8z8z8z8z8z8z8z8uheWG/igi92IXUNpkjO0rOQ5byMi.Ye', 'admin')
        END`
    ];
...
app.get('/api/admin/stats', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        const result = await request.query(`
            ...
            FROM vs_visitors 
            WHERE CAST(checkin_time AS DATE) = CAST(@today AS DATE)
        `, { today });
