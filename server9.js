...
// Generate beautiful email HTML template WITH EMBEDDED QR CODE
function generateVisitorEmailHTML(visitorData, hasPhoto = false, serverUrl = '') {
  ...
  // Build QR code section - QR will be embedded as CID attachment
  const qrCodeSection = `
    <div class="qr-section">
      ...
      <p style="margin-top: 10px; color: #94A3B8; font-size: 11px;">
        If QR code is not visible, please check your email settings or contact security.
      </p>
    </div>
  `;

  // Alternative text-based representation of QR data
  const qrDataText = `
    <div style="background: #F8F9FC; padding: 15px; border-radius: 8px; margin-top: 15px; border-left: 4px solid ${SEEDS_BRANDING.secondaryColor};">
      <h4 style="color: ${SEEDS_BRANDING.primaryColor}; margin: 0 0 10px 0; font-size: 14px;">📋 QR Code Data (Manual Entry):</h4>
      <div style="font-family: monospace; font-size: 12px; color: #4A5568;">
        <div><strong>ID:</strong> ${visitorData.qr_id || 'N/A'}</div>
        <div><strong>Name:</strong> ${visitorData.visitor_name}</div>
        <div><strong>Check-in:</strong> ${formattedTime}</div>
        <div><strong>Purpose:</strong> ${visitorData.purpose}</div>
        <div><strong>Host:</strong> ${visitorData.host_employee || 'N/A'}</div>
      </div>
    </div>
  `;
      ...
      <style>
        * {
        ...
        .qr-fallback {
          ...
          border-radius: 10px;
          margin-top: 20px;
          border-left: 4px solid ${SEEDS_BRANDING.secondaryColor};
        }
      ...
      <div class="email-container">
        ...
        <div class="content">
          ...
          <div class="visitor-card">
            <h2 class="card-title">
              <span style="font-size: 24px;">👤</span> Visitor Details
            </h2>
            
            <div class="info-grid">
              <div class="info-item">
                <span class="info-label">Visitor Name</span>
                <span class="info-value" style="color: ${SEEDS_BRANDING.primaryColor}; font-weight: 600;">${visitorData.visitor_name}</span>
              </div>
              ...
              <div class="info-item">
                ...
                <span class="info-value" style="font-family: monospace; color: ${SEEDS_BRANDING.secondaryColor};">${visitorData.qr_id || visitorData.visitor_id || 'N/A'}</span>
              </div>
            </div>
          </div>
        ...
        <div class="footer">
          ...
          <p class="contact-info">
            <strong>Seeds Financial Capital Pvt. Ltd.</strong><br>
            Security Department<br>
            For assistance, contact: security@seedsfincap.com
          </p>
          <p class="contact-info" style="margin-top: 15px; font-size: 11px;">
    ...
    <head>
      ...
      <style>
        ...
        * {
        ...
        .duration-badge {
          background: linear-gradient(135deg, ${SEEDS_BRANDING.secondaryColor}, #00B894);
          color: white;
          padding: 12px 30px;
          border-radius: 30px;
          font-size: 18px;
        ...
        <div class="content">
          ...
          <div class="details-grid">
            <div class="detail-item">
              ...
              <div class="detail-value" style="color: ${SEEDS_BRANDING.primaryColor};">${visitorData.visitor_name}</div>
            </div>
          ...
          <div style="text-align: center; margin-top: 30px; padding: 20px; background: #F0F4FF; border-radius: 12px; border: 1px solid ${SEEDS_BRANDING.borderColor};">
            <p style="color: #4A5568; margin-bottom: 10px; font-weight: 600;">
              🔒 Security Status: Visitor has exited the building and the visit is now closed.
            </p>
