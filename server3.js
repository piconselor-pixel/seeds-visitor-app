...
async function createTables() {
  // IMPORTANT: generate bcrypt hash for 'admin123' in a small Node script and paste here
  // Example script:
  // const bcrypt = require('bcrypt'); (async()=>console.log(await bcrypt.hash('admin123',10)))();
  const ADMIN_HASH = '$2b$10$XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXYYYYYYYYYYYYYYYYYYYYY'; // TODO: replace
